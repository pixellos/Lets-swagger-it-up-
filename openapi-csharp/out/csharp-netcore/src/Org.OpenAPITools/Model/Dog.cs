...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class Dog : Animal, IEquatable<Dog>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="Dog" /> class.
        /// </summary>
        /// <param name="bark">Some bark desc.</param>
        /// <param name="discriminator">discriminator (required) (default to &quot;Dog&quot;).</param>
        public Dog(string bark = default(string), string discriminator = "Dog") : base()
        {
            // to ensure "discriminator" is required (not null)
            if (discriminator == null)
            {
                throw new ArgumentNullException("discriminator is a required property for Dog and cannot be null");
            }
        ...
        /// Some bark desc
        /// </summary>
        /// <value>Some bark desc</value>
        [DataMember(Name = "bark", EmitDefaultValue = true)]
